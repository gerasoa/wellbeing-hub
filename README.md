...
## Navbar
The navbar is designed for individuals new to mental health topics, caregivers, family members, self-help seekers, and general learners. Its purpose is to provide an intuitive and user-friendly navigation experience, allowing users to easily explore the various resources and information available on the Wellbeing Hub.

### Technologies Used:
- [Bootstrap Nav component](https://getbootstrap.com/docs/5.3/components/navbar/#nav): Ensures full responsiveness and adaptability to different screen sizes.

- [JavaScript](https://www.w3schools.com/js/): Enhances interactivity and functionality of the navbar.
...
### Technologies Used:
- Background Image: Sourced from [Unsplash](https://unsplash.com/), a popular platform for high-quality, freely usable images.
- Typography: Text shadow applied to the font to improve contrast and readability.
- Action Button: Styled using the [Bootstrap Button component](https://getbootstrap.com/docs/5.3/components/buttons/) to be visually appealing and encourage users to take action.
...
![beginner's guide image](https://github.com/gerasoa/wellbeing-hub/blob/main/assets/images/docs/beginners-guide.png)
